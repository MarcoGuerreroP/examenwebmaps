...
class GetCountryPage extends StatefulWidget {
  GetCountryPage({Key key}) : super(key: key);

  @override
  _GetCountryPageState createState() => _GetCountryPageState();
}

class _GetCountryPageState extends State<GetCountryPage> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(),
        body: FutureBuilder(
          future: DatabaseHelper.database.getPeopleWithCounty(model.country),
